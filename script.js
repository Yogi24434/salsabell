...
const nomor_hp_yang_ngirim = "+6281999516708"
...
const kata = [
  `Selamat ulang tahun ${nama} cantik, 🎂`,
  `Jaga kesehatannyaaa, jangan pikirin kata-kata orang yang ga suka ke kamu.  🙃`,
  `Selalu tersenyum, walaupun banyak masalah di tahun sebelumnya`,
  `Jangan lupa di makan 🍰 nya, walau virtual hehe`,
  `Kamu hebat karena berhasil menyelesaikan banyaknya masalah di tahun kemarin, tetap semangat ya ${nama} cantik 🙌✨`
]
